...
public class FanControlUsingThread extends JFrame implements ActionListener, AdjustmentListener
{
	...
	{
		FanControlUsingThread fanControl = new FanControlUsingThread ();	
	}
} 
